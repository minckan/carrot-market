  ...
  return (
    <div className='px-4 py-10'>
      <div className='mb-8'>
        ...
        <div className=' mt-5'>
          <h1 className='text-xl font-bold text-gray-900'>Galaxy S50</h1>
          ...
          <div className='flex items-center justify-between space-x-2'>
            <button className='flex-1 bg-orange-500 text-white py-3 rounded-md  shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 font-medium hover:bg-orange-600'>Talk to seller</button>
