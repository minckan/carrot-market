    ...
    <div className=' mt-16 px-4'>
      ...
      <div className='mt-8'>
        <div className=' flex flex-col items-center'>
          ...
          <div className='grid w-full border-b grid-cols-2 gap-16 mt-8'>  
            <button className={cls(" pb-4 font-medium border-b-2", method === 'email'
                ? 'text-orange-400 border-orange-500' : 'border-transparent text-gray-500'
                )} onClick={onEmailClick}>Email</button>
            <button  className={cls(" pb-4 font-medium  border-b-2", method === 'phone'
                ? 'text-orange-400 border-orange-500' : 'border-transparent text-gray-500'
        ...
        <form className='flex flex-col mt-8'>
          ...
          <div className=' mt-1'>
            {method === "email" ? <input type="email" required className=' appearance-none w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500'/> : null}
            {method === "phone" ? (
              <div className='flex rounded-md shadow-sm'>
                ...
                <input type="number" className='appearance-none w-full px-3 py-2 border border-gray-300 rounded-l-none rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500' required />
              </div>
            ) : null}
          </div>
